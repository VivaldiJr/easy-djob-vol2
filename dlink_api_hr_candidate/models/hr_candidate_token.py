...
class HrCandidateToken(models.Model):
    _name = "hr.candidate.token"
    _description = _("Token For Valid Email")
    email = fields.Char(string="Email of Candidate")
